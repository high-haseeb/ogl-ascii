import { Renderer,Box,Mesh, Camera, Transform, Orbit, Program, GLTFLoader, Vec3, Vec2, Texture, TextureLoader, Post } from "ogl";
...
const fragment = /* gjlsl */ `
                ...
                void main() {
                    ...
                    // vec4 asciiCharacter = texture2D(uCharacters, vUv);
                    vec4 asciiCharacter = texture2D(tMap, pixelizedUV);

                    asciiCharacter.rgb = vec3(1.0) * asciiCharacter.r;
...

{
  ...
  async function loadInitial() {
    gltf = await GLTFLoader.load(gl, `./assets/hershel.glb`);
    // addGLTF(gltf);
  }
